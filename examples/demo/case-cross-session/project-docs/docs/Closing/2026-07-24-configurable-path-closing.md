...
| spec 合规检查 | done | 见 [Spec Compliance Report](../Reviews/2026-07-24-configurable-path-compliance-report.md)：场景覆盖、架构一致性、排除范围均通过；无破坏性变更（B4）；沿用既有持久化抽象（B5），未新造；验证证据匹配度命中 1 类（新增/扩展 CLI 入口），契约测试与兼容性检查证据齐备。 |
...
- Spec Compliance Report：`examples/demo/case-cross-session/project-docs/docs/Reviews/2026-07-24-configurable-path-compliance-report.md`
